# Generated by Django 2.1.1 on 2019-05-07 11:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboard.CameraMaster')),
            ],
        ),
        migrations.CreateModel(
            name='Model',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_plate',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboard.NumberPlate')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camera', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboard.CameraMaster')),
                ('vehicle',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Dashboard.VehicleMonitor')),
            ],
        ),
        migrations.CreateModel(
